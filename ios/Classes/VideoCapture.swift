...
public class VideoCapture: NSObject {
    ...
    var photoCaptureCompletionHandler: ((CIImage?) -> Void)? = nil
    ...
    public func capture(completion: @escaping (CIImage?) -> Void) {  // Change the completion handler type
...
extension VideoCapture: AVCaptureVideoDataOutputSampleBufferDelegate {
    public func captureOutput(
        ...
        self.sampleBuffer = sampleBuffer // 샘플버퍼 줄기차게 업데이트
    }
}
...
extension VideoCapture: AVCapturePhotoCaptureDelegate {
    ...
    public func photoOutput(
        ...
        if let ciImage = CIImage(image: image) {
            photoCaptureCompletionHandler?(ciImage)
        } else {
